...
def status_from_event_type(event_type: str, prefix: str) -> str:
    known_statuses = {
        ...
        "OperationScheduled": "Queued",
        "OperationSetup": "Setup",
        ...
        "QCStarted": "QC",
        "QCPassed": "Finished",
        "QCFailed": "BlockedByNCR",
        "NCROpened": "BlockedByNCR",
        "NCRApprovalRequested": "WaitingQCApproval",
        "NCRApproved": "WaitingQCApproval",
        "NCRRejected": "BlockedByNCR",
        "NCRDispositionDecided": "Finished",
        "ReworkCreated": "Rework",
        "ReplacementOrderCreated": "WaitingReplacement",
